...
namespace nsFTP
{
	...
	private: // prevent copy action
		...
		const IInterface& operator=(const IInterface&) = delete;
	};
	...
	{
	public:
		enum TCommandEnum { cmdABOR, cmdACCT, cmdALLO, cmdAPPE, cmdCDUP, cmdCWD, cmdDELE, cmdFEAT, cmdHELP, cmdLIST, cmdLSTA, cmdMDTM, cmdMKD, cmdMODE, cmdNLST, cmdNOOP, cmdOPEN, cmdPASS, cmdPASV,
			cmdPORT, cmdPWD, cmdQUIT, cmdREIN, cmdREST, cmdRETR, cmdRMD, cmdRNFR, cmdRNTO, cmdSITE, cmdSIZE, cmdSMNT, cmdSTAT, cmdSTOR, cmdSTOU, cmdSTRU, cmdSYST, cmdTYPE, cmdUSER, cmdXCRC, };
		...
		static const CCommand FEAT() { return cmdFEAT; }
		static const CCommand HELP() { return cmdHELP; }
		static const CCommand LIST() { return cmdLIST; }
		static const CCommand LSTA() { return cmdLSTA; } // list all
	...
	public:
		...
		CLogonInfo(const tstring& strHostname, USHORT ushHostport = DEFAULT_FTP_PORT, const tstring& strUsername = ANONYMOUS_USER,
			const tstring& strPassword = _T("anonymous@user.com"), const tstring& strAccount = _T(""), bool utf8 = false);
		...
		bool                 Utf8()       const { return m_bUtf8; }
	...
	private:
		...
		bool           m_bUtf8;         ///< force utf-8 encoding
	};
