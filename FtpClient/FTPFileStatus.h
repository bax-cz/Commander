...
namespace nsFTP
{
	...
	typedef std::shared_ptr<CFTPFileStatus> TFTPFileStatusShPtr;
	...
	public:
		...
		long long&     Size() { return m_llSize; };
	...
	private:
		...
		long long      m_llSize;                  ///< number of octets
	...
	class CFTPFileStatusContainerSort
	{
		...
		CFTPFileStatusContainerSort& operator=(const CFTPFileStatusContainerSort&) = delete; // no implementation for assignment operator
