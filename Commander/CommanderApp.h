...
#define UM_OVERLAYSDONE       UM_FIRSTMESSAGE + 6
#define UM_CALCSIZEDONE       UM_FIRSTMESSAGE + 7
#define UM_ARCHOPENDONE       UM_FIRSTMESSAGE + 8
#define UM_FINDTEXTDONE       UM_FIRSTMESSAGE + 9
#define UM_NEIGHBORDONE       UM_FIRSTMESSAGE + 10

#define UM_DIRCONTENTCH       UM_FIRSTMESSAGE + 11
#define UM_CARETPOSCHNG       UM_FIRSTMESSAGE + 12
#define UM_REPORTMSGBOX       UM_FIRSTMESSAGE + 13
#define UM_FASTCOPYINFO       UM_FIRSTMESSAGE + 14

#define UM_LASTMESSAGE        UM_FIRSTMESSAGE + 15
