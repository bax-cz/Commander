...
static void cacheOffset(DMG *dmg, size_t location) {
  int i;
  int j;
  uint64_t sector;
...
static int dmgFileRead(io_func *io, size_t location, size_t size, void *buffer) {
  DMG *dmg;
  size_t toRead;
...
static int dmgFileWrite(io_func *io, size_t location, size_t size,
                        void *buffer) {
