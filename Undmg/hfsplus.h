...
#define HFS_READ(a, b, c, d) ((*((a)->read))(a, b, c, d))
#define HFS_WRITE(a, b, c, d) ((*((a)->write))(a, b, c, d))
#define HFS_CLOSE(a) ((*((a)->close))(a))
#define HFS_COMPARE(a, b, c) ((*((a)->compare))(b, c))
#define HFS_READ_KEY(a, b, c) ((*((a)->keyRead))(b, c))
#define HFS_WRITE_KEY(a, b, c, d) ((*((a)->keyWrite))(b, c, d))
#define HFS_READ_DATA(a, b, c) ((*((a)->dataRead))(b, c))
...
typedef BTKey *(*dataReadFunc)(size_t offset, struct io_func_struct *io);
typedef void (*keyPrintFunc)(BTKey *toPrint);
typedef int (*keyWriteFunc)(size_t offset, BTKey *toWrite,
...
int allocate(RawFile *rawFile, size_t size);
