...
typedef int(*tChangeVolProcW)(WCHAR *ArcName, int Mode);
/* Notify that data is processed - used for progress dialog */
typedef int(*tProcessDataProcW)(WCHAR *FileName, int Size, LPARAM userData);
typedef int(*tPkCryptProcW)(int CryptoNr, int Mode,
