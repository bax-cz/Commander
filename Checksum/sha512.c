...
#define SWAP(x) ((((x) & 0x00000000000000FFULL) << 56) | \
...
/* Forward declaration */
extern void sha512_process_block (const void *buffer, size_t len, sha512_ctx *ctx);
...
*/
void
sha512_init_ctx (sha512_ctx *ctx)
{
...
void
sha384_init_ctx (sha512_ctx *ctx)
{
...
void *
sha384_read_ctx (const sha512_ctx *ctx, void *resbuf)
{
  int i;
  char *r = resbuf;
...
void *
sha512_finish_ctx (sha512_ctx *ctx, void *resbuf)
{
...
void *
sha384_finish_ctx (sha512_ctx *ctx, void *resbuf)
{
  sha512_conclude_ctx (ctx);
...
shaxxx_stream (FILE *stream, char const *alg, void *resblock,
               ssize_t hashlen, void (*init_ctx) (sha512_ctx *),
               void *(*finish_ctx) (sha512_ctx *, void *))
{
...
void
sha512_process_bytes (const void *buffer, size_t len, sha512_ctx *ctx)
{
...
# define UNALIGNED_P(p) ((uintptr_t) (p) % __alignof (u64) != 0)
